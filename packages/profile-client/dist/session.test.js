...
describe('userSessionChallenge', () => {
    it('matches the backend challenge format', () => {
        expect(userSessionChallenge('NQ17 VERV F3MQ 283T NRSR FPJG 55BJ PMHC N8MD', 1700000000)).toBe('nimconnect-session:v1:NQ17VERVF3MQ283TNRSRFPJG55BJPMHCN8MD:1700000000');
    });
});
